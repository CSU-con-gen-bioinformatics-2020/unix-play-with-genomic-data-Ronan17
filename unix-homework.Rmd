...
```{bash}
cd ~/OneDrive/Documents/M2/Stage/Cours US/Cours Eric/unix-play-with-genomic-data-Ronan17
pwd
```
...
```
Since there is a DPCh_plate1_A06_S6.R2.
...
```
They have almost the same description, the only changes are the two numbers before the "/2".
```
...
Sorry I forgot to put the ls -l at the end, so the change was already made.
